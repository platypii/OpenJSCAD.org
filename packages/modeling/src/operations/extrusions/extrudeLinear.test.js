...
test('extrudeLinear (twist)', (t) => {
  ...
  let pts = geom3.toPoints(geometry3)
  let exp = [
    [[5, -5, 0], [5, 5, 0], [7.0710678118654755, 0, 15]],
    [[5, -5, 0], [7.0710678118654755, 0, 15], [0, -7.0710678118654755, 15]],
    [[5, 5, 0], [-5, 5, 0], [-4.440892098500626e-16, 7.0710678118654755, 15]],
    [[5, 5, 0], [0, 7.0710678118654755, 15], [7.0710678118654755, 0, 15]],
    [[-5, 5, 0], [-5, -5, 0], [-7.0710678118654755, 0, 15]],
    [[-5, 5, 0], [-7.0710678118654755, 0, 15], [-4.440892098500626e-16, 7.0710678118654755, 15]],
    [[-5, -5, 0], [5, -5, 0], [4.440892098500626e-16, -7.0710678118654755, 15]],
    [[-5, -5, 0], [0, -7.0710678118654755, 15], [-7.0710678118654755, 0, 15]],
    [[7.0710678118654755, 0, 15], [0, 7.0710678118654755, 15], [-7.0710678118654755, 0, 15], [0, -7.0710678118654755, 15]],
    [[5, -5, 0], [-5, -5, 0], [-5, 5, 0], [5, 5, 0]]
  ]
  t.notThrows(() => geom3.validate(geometry3))
  t.is(pts.length, 10)
