...
test('extrudeRotate: (overlap +/-) extruding of a geom2 produces an expected geom3', (t) => {
  ...
  let exp = [
    ...
    [[7, 0, 8], [7, 0, -8], [0, 7, -8]],
    [[7, 0, 8], [0, 7, -8], [0, 7, 8]],
    [[0, 7, 8], [0, 7, -8], [0, 0, -8], [0, 0, 8]],
    [[0, 0, 8], [0, 0, -8], [7, 0, -8], [7, 0, 8]]
  ]
  ...
  exp = [
    [[1, 0, -8], [0, -0, -8], [0.7071067811865479, 0.7071067811865471, -8]],
    [[2, 0, 4], [1, 0, -8], [0.7071067811865479, 0.7071067811865471, -8]],
    [[2, 0, 4], [0.7071067811865479, 0.7071067811865471, -8], [1.414213562373095, 1.4142135623730951, 4]],
    [[1, 0, 8], [2, 0, 4], [1.414213562373095, 1.4142135623730951, 4]],
    [[1, 0, 8], [1.414213562373095, 1.4142135623730951, 4], [0.7071067811865472, 0.7071067811865478, 8]],
    [[0, 0, 8], [1, 0, 8], [0.7071067811865472, 0.7071067811865478, 8]],
    [[0.7071067811865479, 0.7071067811865471, -8], [0, 0, -8], [0, 1, -8]],
    [[1.414213562373095, 1.4142135623730951, 4], [0.7071067811865479, 0.7071067811865471, -8], [0, 1, -8]],
    [[1.414213562373095, 1.4142135623730951, 4], [0, 1, -8], [0, 2, 4]],
    [[0.7071067811865472, 0.7071067811865478, 8], [1.414213562373095, 1.4142135623730951, 4], [0, 2, 4]],
    [[0.7071067811865472, 0.7071067811865478, 8], [0, 2, 4], [0, 1, 8]],
    [[0, 0, 8], [0.7071067811865472, 0.7071067811865478, 8], [0, 1, 8]],
    [[0, 0, 8], [0, 1, 8], [0, 2, 4], [0, 1, -8], [0, 0, -8]],
    [[0, 0, -8], [1, 0, -8], [2, 0, 4], [1, 0, 8], [0, 0, 8]]
  ]
  t.notThrows(() => geom3.validate(obs))
  t.is(pts.length, 14)
  t.true(comparePolygonsAsPoints(pts, exp))
