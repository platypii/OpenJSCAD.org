...
const divideSegment = require('./divideSegment')
const segmentIntersection = require('./segmentIntersection')
const compareEvents = require('./compareEvents')
const {
  NON_CONTRIBUTING,
  SAME_TRANSITION,
...
module.exports = possibleIntersection
